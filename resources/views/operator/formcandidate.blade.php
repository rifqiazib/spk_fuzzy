        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <div class="card-header">
                <h3 class="card-title">Tambah Data Calon Penerima</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('operator.create.candidate')}}" method="post">
                @csrf
                <div class="card-body">
                <div class="form-group">
                  ...
                  <label for="validationCustom01" class="form-label">Tanggungan (orang)</label>
                    ...
                    <input  name="tanggungan" class="form-control"  placeholder="Tanggungan">
                  </div>
                  <div class="form-group">
                  <label for="validationCustom01" class="form-label">Penghasilan</label>
                    <label for="penghasilan"></label>
                    <input  name="penghasilan" class="form-control"  placeholder="Penghasilan">
                  </div>
                  <div class="form-group">
                  ...
                  <label for="validationCustom01" class="form-label">Jumlah Kepala Keluarga</label>
                    ...
                    <input  name="jumlah_kepala_keluarga" class="form-control"  placeholder="Kepala Keluarga">
                  </div>

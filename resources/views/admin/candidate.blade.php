		...
		<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<form method="post" action="{{route('importexcel')}}" enctype="multipart/form-data">
                    ...
                    <div class="col-5"> 
                    <a href="{{route('form.candidate')}}"><button type="submit" class="btn btn-primary">Add New</button></a>
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="/candidates/{{$candidate->id}}/edit"><button class="btn btn-warning btn-sm">EDIT</button></a>
                      <a href="/candidates/{{$candidate->id}}/delete"><button class="btn btn-danger btn-sm">DELETE</button></a>
                      </td>
                    </tr>
                  @endforeach

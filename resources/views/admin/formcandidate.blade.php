        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <div class="card-header">
                <h3 class="card-title">Tambah Data Calon Penerima Baru</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('create.candidate')}}" method="post">
                @csrf
                <div class="card-body">
                <div class="form-group">
                  ...
                  <label for="validationCustom01" class="form-label">Nama</label>
                    ...
                    <input name="name" id="inputname" class ="form-control" placeholder="Name" rows="4"></input>
                  </div>
                
                  <div class="form-group">
                  <label for="validationCustom01" class="form-label">Tanggungan (orang)</label>
                    <label for="Tanggungan"></label>
                    <input  type="number" name="tanggungan" class="form-control"  placeholder="Tanggungan">
                  </div>
                  <div class="form-group">
                  <label for="validationCustom01" class="form-label">Penghasilan</label>
                    <label for="penghasilan"></label>
                    <input  type="number" name="penghasilan" class="form-control"  placeholder="Penghasilan">
                  </div>
                  <div class="form-group">
                  ...
                  <label for="validationCustom01" class="form-label">Jumlah Kepala Keluarga</label>
                    ...
                    <input type="number" name="jumlah_kepala_keluarga" class="form-control"  placeholder="Kepala Keluarga">
                  </div>

...
<body id="page-top">
    ...
    margin-left: 3rem;">
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('create.subcriteria')}}" method="post">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="subcriteria_code" id="inputname" class ="form-control" placeholder="" rows="4"></input>
                  </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputname">Start</label>
                    <input name="start" id="inputname" class ="form-control" placeholder="" rows="4"></input>
                  </div>
                  <div class="form-group">

...
<body id="page-top">
  ...
  <form class="row g-3" action="{{ route('criterias.store') }}" method="POST" >
        @csrf
    
      <div class="col-auto">
        <label for="inputPassword2" >Kriteria</label>
        <input type="text "name="criteria_name" class="form-control" id="inputPassword2" placeholder="Tambah Kriteria">
      </div>
      <div class="col-auto">
          ...
          <tr>
            ...
            <td class="border px-8 py-4">
              <div class="flex flex-row gap-3">
                ...
                <a href="/criteria/{{$criteria->id}}/subcriteria"><button type="submit" class="btn btn-primary mb-3"> SubCriteria </button></a>
              </div>
            </td>
          </tr>
          @empty

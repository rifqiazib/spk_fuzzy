              ...
              <form action="\profile\{{$user->id}}\update" method="post">
                ...
                <div class="card-body">
                  ...
                  <label for="validationCustom01" class="form-label">Nama</label>
                    ...
                    <input name="name" value="{{$user->name}}" id="inputname" class ="form-control" placeholder="Name" rows="4"></input>
                  </div>
                  <div class="form-group">
                  <label for="validationCustom01" class="form-label">Alamat</label>
                    <label for="alamat"></label>
                    <input  name="address" value="{{$user->password}}" class="form-control"  placeholder="Alamat">
                  </div>
                  <div class="form-group">
